...
export const OPERATION_FIELDS = {
    ...
    optimizePath: { name: 'optimizePath', label: 'Optimize Path (GA)', units: '', input: ToggleInput },
    gaPopulation: { name: 'gaPopulation', label: 'GA Population', units: '', input: NumberInput, condition: (op) => op.optimizePath },
    gaGenerations: { name: 'gaGenerations', label: 'GA Generations', units: '', input: NumberInput, condition: (op) => op.optimizePath },
    gaCrossoverRate: { name: 'gaCrossoverRate', label: 'GA Crossover Rate', units: '', input: NumberInput, condition: (op) => op.optimizePath },
    gaMutationRate: { name: 'gaMutationRate', label: 'GA Mutation Rate', units: '', input: NumberInput, condition: (op) => op.optimizePath },
